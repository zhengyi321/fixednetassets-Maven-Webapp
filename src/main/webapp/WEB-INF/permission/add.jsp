  ...
  <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
    ...
    vAlign=top align=middle>
          <DIV>
				...
				<form action="/fixednetassets/permission/addsubmit.do" method="post" class="gridView" enctype="multipart/form-data">
			    ...
			    <table class="gridView" align="left">
			        ...
			        <tr>
			            <td width="10%" class="tableleft">权限键值:</td>
			        ...
			        <tr>
			            ...
			            <td><input type="text" name="url" id="url" class="gridViewItem"/></td>
			        </tr>
			        <tr>
			            <td width="10%" class="tableleft">菜单类别:</td>
			            
			            <td><select id="type" name="type" class="gridViewItem">
