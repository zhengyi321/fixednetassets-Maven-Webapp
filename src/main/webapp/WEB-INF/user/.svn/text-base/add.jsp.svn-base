  ...
  <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
    ...
    vAlign=top align=middle>
          <DIV>
				...
				<form action="/fixednetassets/user/addsubmit.do" method="post" class="gridView" enctype="multipart/form-data">
			    ...
			    <table class="gridView" align="left">
			        ...
			        <tr>
			      	...
			      	<tr>
			            ...
			            <td><input type="text" name="pass" id="pass" class="gridViewItem"/></td>
			        </tr> 
			        <tr>
