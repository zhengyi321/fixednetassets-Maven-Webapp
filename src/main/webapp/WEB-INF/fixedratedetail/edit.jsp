  ...
  <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
    ...
    vAlign=top align=middle>
          <DIV>
				...
				<form action="/fixednetassets/fixedratedetail/editsubmit.do" method="post" class="gridView" enctype="multipart/form-data">
			    ...
			    <table class="gridView" align="left">
			        ...
			        <tr>
			            ...
			            <td><input type="xt" name="remark" id="remark" class="gridViewItem" value="${fixedDetail.remark }"/></td>
			        </tr> 
			      	<tr>
			            <td width="10%" class="tableleft">余额(数量):</td>
			            
			            <td><input type="text" name="fixedBalanceNum" id="fixedBalanceNum" class="gridViewItem" value="${fixedDetail.fixedBalanceNum }"/></td>
			        </tr> 
			        <tr>
			            <td width="10%" class="tableleft">余额(金额):</td>
			            
			            <td><input type="text" name="fixedBalancePrice" id="fixedBalancePrice" class="gridViewItem" value="${fixedDetail.fixedBalancePrice }"/></td>
			        </tr>
			        
			        <tr>
			            <td width="10%" class="tableleft">本月提取金额:</td>
			            
			            <td><input type="text" name="sumDepreciationCurrentmonth" id="sumDepreciationCurrentmonth" class="gridViewItem" value="${fixedDetail.sumDepreciationCurrentmonth }"/></td>
			        </tr>
			        
			        <tr>
			            <td width="10%" class="tableleft">累计折旧:</td>
			            
			            <td><input type="text" name="sumDepreciationTotal" id="sumDepreciationTotal" class="gridViewItem" value="${fixedDetail.sumDepreciationTotal }"/></td>
			        </tr>
			        
			        <tr>
			            <td width="10%" class="tableleft">固定资产净值:</td>
			            
			            <td><input type="text" name="fixedNetWorth" id="fixedNetWorth" class="gridViewItem" value="${fixedDetail.fixedNetWorth}"/></td>
			        </tr>
			      	...
			      	<tr>
			            ...
			            <c:choose>
			            	<c:when test="${fixedDetail.manageFee == '' }">
			            	<option value="made" selected>制造费用</option>
			            	</c:when>
			            	<c:otherwise>
			            	<option value="manage" selected>管理费用</option>
			            	</c:otherwise>
			            </c:choose>
